...
export declare class HomeworkController {
    ...
    submitHomework(req: any, files?: Express.Multer.File[]): Promise<import("mongoose").Document<unknown, {}, import("../schemas/homework.schema").Homework, {}, {}> & import("../schemas/homework.schema").Homework & {
